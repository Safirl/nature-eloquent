...
export default class Sky implements LifeTimeObject{
    ...
    constructor(time: number, parentDebugFolder?: GUI) {
        ...
        this.skyBoxMaterial = new THREE.ShaderMaterial({
                ...
                side: THREE.BackSide,
                uniforms: {
                    color0: {value: new THREE.Color(this.gradients[this.currentGradientIndex][0])},
                    color1: {value: new THREE.Color(this.gradients[this.currentGradientIndex][1])},
                    color2: {value: new THREE.Color(this.gradients[this.currentGradientIndex][2])}
                }
            })
