...
export default class OutlinerManager implements LifeTimeObject {
	...
	constructor() {
		if (!Experience.instance)
			throw new Error(
				"OutlineManager initialization failed: Experience.instance is not available. Make sure Experience is initialized before creating the OutlineManager."
			);
	...
	update = () => {};
	destroy = () => {
		if (this.renderer) this.renderer.setComposer(null);
	};
